...
| [`docs/case-study/`](docs/case-study/)         | Sanitized decision, design, implementation, and validation evidence captured throughout the project for the eventual portfolio case study                                                                 |
