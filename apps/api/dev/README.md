...
Production can never trust these keys — its env validation rejects `MOCK_JWKS` and it remains issuer-free until an accepted provider is integrated after Phase 0B (ADR-132/134).
